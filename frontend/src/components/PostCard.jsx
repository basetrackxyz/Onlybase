...
export default function PostCard({ post }) {
  ...
  return (
    <article
      className="border-b border-gray-100 px-4 py-4 active:bg-gray-50 transition-colors duration-150"
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5">
            <Link to={`/creator/${creator.id}`} className="font-semibold text-[15px] text-black truncate hover:underline">
              {creator.name}
            </Link>
        ...
        <button
          className="text-xs font-semibold px-3 py-1.5 rounded-full border border-gray-200 hover:bg-gray-50 transition-colors"
      ...
      {/* Content */}
      <p className="text-[15px] leading-relaxed text-black whitespace-pre-line mb-3">
        {post.content}
      </p>
